...
class SlidableExam extends StatefulWidget {
  const SlidableExam({super.key});

  @override
  State<SlidableExam> createState() => _SlidableExamState();
}

class _SlidableExamState extends State<SlidableExam> {
